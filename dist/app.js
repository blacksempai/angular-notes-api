...
app.use(express_1.default.static('../client/dist/client'));
app.get('*', function (req, res) {
    res.sendFile(path_1.default.resolve(__dirname, '..', 'client', 'dist', 'client', 'index.html'));
});
console.log(path_1.default.resolve(__dirname, '..', 'client', 'dist', 'client', 'index.html'));
